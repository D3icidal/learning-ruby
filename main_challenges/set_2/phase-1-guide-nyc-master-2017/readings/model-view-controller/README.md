...
You will continue to encounter the Model-View-Controller pattern while at Dev main_challenges.  In Phases 2 and 3 the divisions between the parts of your application will be more obvious—your application files will even be divided into *models*, *views*, and *controllers* folders.  Working on the command line in Phase 1, the distinction between parts of our application might feel a little artificial, but implementing the Model-View-Controller pattern is just as doable in this context.


[Video available at talks.devmain_challenges.com](https://talks.devmain_challenges.com/intro-to-model-view-controller).
