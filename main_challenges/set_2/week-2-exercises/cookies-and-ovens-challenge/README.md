...
*Note:* If a refresher on objects is in order, here's a video from Dev main_challenges days of yesteryear: DBC founder Shereef Bishay going over [Objects and Classes][objects and classes video] from June 18, 2012.
