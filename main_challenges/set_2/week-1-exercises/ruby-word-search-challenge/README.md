...
## Conclusion
The snaking algorithm is one of the more difficult challenges with which we're presented during Dev main_challenges.  How do we feel about it?  Did it go well?  Where did we struggle?
