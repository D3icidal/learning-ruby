...
### Conclusion
As has been said in other challenges, Active Record associations are going to play a big role in our applications as we move through Dev main_challenges.  The has many association is one of the major association types. We need to be familiar with it: both how to declare the association and how to employ the methods provided to us when we make the declaration.
