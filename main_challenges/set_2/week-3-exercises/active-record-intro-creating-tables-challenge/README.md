...
In this challenge and many of the challenges we'll encounter going forward at Dev main_challenges, we'll need to run through some setup before beginning to work through the challenge.  We'll need to make sure that all the required gems are installed and then create the database that we'll be working with (see Figure 4).
