...
* Read our [introduction to the terminal](http://estherleytush.com/stack-for-yourself/comp-sci/2016/10/01/command-line/) introduction
...
Note: the terms *command line*, *command-line*, *command line interface (CLI)*, *terminal*, *shell*, and *bash* can all mean the same thing in this context: a text-based interface to your computer where you can run code (like [bash](http://cs.lmu.edu/~ray/notes/bash/) if you're on a Mac or Linux computer).
...
* **Continue your learning** by checking out our [resources on Ruby](http://estherleytush.com/stack-for-yourself/tag/ruby/).
